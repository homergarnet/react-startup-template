...
const OrderFormPage = () => {
  ...
  const handleRedirect = (value: string) => {
    navigate(`/order-analyst/order-form/worksheet-po-detail?id=${value}`); // Replace `row.id` with your value
  };
                ...
                if (
                  ...
                  return (
                    ...
                    >
                      <StyledTableCellBody>
                        <Checkbox
                          ...
                          onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                            debouncedHCCBOnChange(row.Week_No, e.target.checked)
                          }
                      ...
                      <StyledTableCellBody
                        onClick={() => handleRedirect(row.Original_PO_Eta)}
