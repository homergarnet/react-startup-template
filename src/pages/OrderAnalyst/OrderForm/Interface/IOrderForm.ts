...
export default interface IOrderForm {
  ...
  PO_Numbers: string; // Changed from number to string
  PO_Received_Week_No: string; // Changed from number to string
  Total_Quantity_Ordered: number; // Changed from number to string
